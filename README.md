# GAPS (Generative AI Presentation System)

An open-source, AI-powered presentation generator inspired by Gamma.app that creates beautiful, customizable slides in minutes. This tool is part of the broader GAPS (Generative AI Presentation System) platform.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/Wesley-Kimeli/GAPS.git
   ```
...
You can use either Ollama or LM Studio for using local models in GAPS (Generative AI Presentation System).
...
| API                          | 🔴 Not Started    | Allow developers to use the GAPS (Generative AI Presentation System) presentation to generate content in their own applications. |
...
- All our open-source [contributors](https://github.com/Wesley-Kimeli/GAPS/graphs/contributors)

Have any questions?

- 🐛 [Report a Bug](https://github.com/Wesley-Kimeli/GAPS/issues)
- 💡 [Request a Feature](https://github.com/Wesley-Kimeli/GAPS/issues)
