...
import GapsText from "@/components/globals/gaps-logo";
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Link href="/" className="h-max">
              <GapsText className="h-10 w-[7.5rem] cursor-pointer transition-transform duration-100 active:scale-95"></GapsText>
            </Link>
          </motion.div>
        </div>
